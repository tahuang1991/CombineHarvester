...
int main(int argc, char** argv) {
  ...
  input_dir["em"]  = string(getenv("CMSSW_BASE")) + "/src/CombineHarvester/TAMUHHbbWW/shapes/"+input_folder_em+"/";
  input_dir["mt"]  = string(getenv("CMSSW_BASE")) + "/src/CombineHarvester/TAMUHHbbWW/shapes/"+input_folder_mt+"/";
  input_dir["et"]  = string(getenv("CMSSW_BASE")) + "/src/CombineHarvester/TAMUHHbbWW/shapes/"+input_folder_et+"/";
  input_dir["tt"]  = string(getenv("CMSSW_BASE")) + "/src/CombineHarvester/TAMUHHbbWW/shapes/"+input_folder_tt+"/";
